...
struct Product: Identifiable{
    ...
    static var dummyToppings: [Topping] = [Topping(name: "Puderzucker", price: 2.90), Topping(name: "Sahne", price: 1.00), Topping(name: "heiße Kirschen", price: 1.50), Topping(name: "heiße Pflaumen", price: 1.50), Topping(name: "Schokosauce", price: 0.90), Topping(name: "Erdbeerhimbeersauce", price: 0.90),Topping(name: "Karamellsauce", price: 0.90), Topping(name: "Eis", price: 1.20), Topping(name: "Erdbeerhimbeersauce", price: 1.20),Topping(name: "Eishörnken extra", price: 0.30),Topping(name: "Krokant", price: 0.90),Topping(name: "Karamellisierte Nüsse", price: 1.50),Topping(name: "Knuspriger Streusel", price: 0.90), Topping(name: "Schokostreusel", price: 0.90)]
//    var servingSize
