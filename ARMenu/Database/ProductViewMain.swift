...
struct ProductViewMain: View {
    ...
    var product = Product(image: "", name: "testKuchen", category: "Kuchen", price: 5.4, description: "testKuchen", isVegan: true, isBio: true, isFairtrade: true, nutritionFacts: NutritionFacts(calories: 2, fat: 2, carbs: 2, protein: 2), allergens: ["Milch", "Käse"], additives: ["Süßstoffe", "Farbstoffe"])
            ...
            ScrollView{
                ...
                Button(action: {
                    ...
                    Button("addProduct"){
                        ...
                        viewModel.addProduct(productToAdd: product, imageToAdd: inputImage!)
